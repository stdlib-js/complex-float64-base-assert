...
```javascript
import { isAlmostEqual, isAlmostSameValue, isEqual, isNotEqual, isSameValue, isSameValueZero } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float64-base-assert@v0.1.1-esm/index.mjs';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float64-base-assert@v0.1.1-esm/index.mjs';
